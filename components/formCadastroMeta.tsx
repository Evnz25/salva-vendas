import { postMeta } from "@/services/metaService";
...
export default function FormCadastroMeta({ onSave }: { onSave: () => void }) {
  ...
  const aoMudarData = (evento: any, dataSelecionada?: Date) => {
    ...
    if (dataSelecionada) setDataFinal(dataSelecionada);
  };

  const handleSalvar = async () => {
    if (!qtdVendas) {
      Alert.alert("Atenção", "Preencha a quantidade de vendas alvo.");
      return;
    }
